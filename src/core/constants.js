...
// Boss 关 BGM 强度曲线（src/game/game.js 升压 + src/vr/audio.js _stepBoss 分层依据）
export const BOSS_BGM = {
  START_INTENSITY: 0.45,  // 进关起步强度：已有十六分 ostinato + 心跳 sub，一进场就有压迫感
  MAX_INTENSITY: 1.0,     // 终期上限（触发太鼓滚奏 / 铜管叠小二度 / 不协和尖刺）
  TIME_TO_MAX: 75,        // 拿不到 Boss 血量时，战斗进行多少秒(s)线性升至上限
  RISE_RANGE: 0.55,       // 强度上升幅度：START_INTENSITY + 进度×RISE_RANGE = 上限 1.0
};
